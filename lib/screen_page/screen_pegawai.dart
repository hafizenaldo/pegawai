...
class PegawaiScreen extends StatefulWidget {
  @override
  PegawaiScreenState createState() => PegawaiScreenState();
}
...
class PegawaiScreenState extends State<PegawaiScreen> {
  ...
  Future<ModelPegawai> fetchPegawai() async {
    final response = await http.get(Uri.parse('http://192.168.18.8/pegawai/getPegawai.php'));
  ...
  Future<void> addOrUpdatePegawai({required Datum pegawai}) async {
    String url = pegawai.id.isEmpty
        ? 'http://192.168.18.8/pegawai/addPegawai.php'
        : 'http://192.168.18.8/pegawai/updatePegawai.php';
  ...
  Future<void> deletePegawai(String id) async {
    final response = await http.post(
      Uri.parse('http://192.168.18.8/pegawai/deletePegawai.php'),
      body: {'id': id},
    );
